...
/* harmony import */ var _common_static_terms_terms_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../../common/static/terms/terms.component */ "rywU");
...
/* harmony import */ var _register_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./register-routing.module */ "Ro0S");
/* harmony import */ var _register_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./register.page */ "yhyc");
...
RegisterPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["NgModule"])({
        imports: [
            ...
            _register_routing_module__WEBPACK_IMPORTED_MODULE_7__["RegisterPageRoutingModule"],
...
/* harmony import */ var _services_form_helper_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../../services/form-helper.service */ "mp9f");
/* harmony import */ var src_app_models_from_validation_message__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/models/from-validation-message */ "soHS");
/* harmony import */ var _common_static_terms_terms_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../../common/static/terms/terms.component */ "rywU");
/* harmony import */ var _services_provider_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./../../services/provider.service */ "gs/X");
/* harmony import */ var _services_env_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./../../services/env.service */ "5zL6");
...
let RegisterPage = class RegisterPage {
    constructor(menu, alertService, navContorll, authService, env, providerService, modalController, formHelper) {
        this.menu = menu;
    ...
    presentTermsModal() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_14__["from"])(this.modalController.create({
            ...
            modal.onDidDismiss;
            Object(rxjs__WEBPACK_IMPORTED_MODULE_14__["from"])(modal.onDidDismiss()).subscribe((data) => { });
    ...
    register(form) {
        ...
        if (!form.controls.isProvider.value &&
        ...
        this.authService
            .register(form.value.phone, firstName, lastName, form.value.password, roleId, affiliateCode)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["concatMap"])((result) => {
            {
                return this.authService
                    .requestVerificationCode(form.value.phone, form.value.password)
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])((result) => {
            ...
            if (data != false) {
                this.alertService.presentSuccess("کد اعتبارسنجی به شماره همراه شما راسال شد.");
...
RegisterPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_13__["MenuController"],
        ...
        _services_env_service__WEBPACK_IMPORTED_MODULE_7__["EnvService"],
        ...
        _services_form_helper_service__WEBPACK_IMPORTED_MODULE_3__["FormHelperService"]])
], RegisterPage);
