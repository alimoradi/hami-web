...
/* harmony import */ var _login_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./login-routing.module */ "DdsG");
/* harmony import */ var _login_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./login.page */ "v04T");
...
/* harmony import */ var _services_env_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./../../services/env.service */ "5zL6");
...
/* harmony import */ var src_app_models_from_validation_message__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/app/models/from-validation-message */ "soHS");
...
let LoginPage = class LoginPage {
    constructor(authService, navCtrl, alertService, menu, env, formHelper) {
        ...
        this.loginForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormGroup"]({
            phone: new _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormControl"]("", _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].compose([
                _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required,
                _angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].pattern("(09\\d{9})") //|admin")
            ])),
        ...
        this.authService
            ...
            switch (errorType) {
                case "invalid_credentials":
                    this.alertService.presentError("شماره موبایل یا گذرواژه صحیح نیست.");
                    break;
                case "not_verified":
                    this.alertService.presentError("شماره موبایل اعتبار سنجی نشده است.");
                    return this.authService
                        ...
                        this.alertService.presentError("ارسال پیام اعتبار سنجی با مشکل روبه رو شد.");
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_11__["of"])(false);
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((result) => {
                        if (result != false) {
                    ...
                    break;
                default:
                    this.alertService.presentError("ورود به حساب با مشکل روبرو شده است.");
            }
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_11__["of"])(false);
        }))
            .subscribe((data) => {
...
LoginPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_9__["AuthService"],
        ...
        _services_env_service__WEBPACK_IMPORTED_MODULE_5__["EnvService"],
